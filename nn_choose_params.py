...
class NeuralNetwork(nn.Module):
    def __init__(self):
        ...
        self.linear_relu_stack = nn.Sequential(
            nn.Linear(28*28,params['feature1']),  # 第一层，将28x28的图片展平后输入，输出128个节点
            nn.ReLU(),
            nn.Linear(params['feature1'], params['feature2']),  # 第二层，接收第一层的128个节点，输出256个节点
            nn.ReLU(),
            nn.Linear(params['feature2'], 10)  # 最后一层，输出10个节点，对应10个类别
        )
